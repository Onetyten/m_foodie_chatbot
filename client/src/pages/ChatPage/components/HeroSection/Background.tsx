...
export default function Background() {
  return (
    <>
        ...
        <img src={coffeeCup} className="size-6/12 opacity-40 -z-10 absolute object-contain -right-2/12 top-0 scale-50"/>
        <img src={coffeeMug} className="size-6/12 opacity-40 -z-10 absolute object-contain -right-2/12 -bottom-12 scale-25 rotate-12"/>
