...
export default function ChatBox() {
  ...
  return (
    <div className="flex w-full chat-box font-outfit text-sm pb-12 overflow-scroll scroll-hide bg-background text-secondary-100 flex-1 flex-col justify-start mt-12 items-center gap-3 h-full">
