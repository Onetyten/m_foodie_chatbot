...
export default function OptionSelect(props:propType) {
  ...
  return (
    <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:1, ease:['easeOut']}} className="w-72 rounded-sm h-10 text-sm flex justify-between px-4 items-center border border-secondary-100 cursor-pointer">
